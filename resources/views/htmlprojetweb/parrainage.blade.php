...
<head>
    ...
    <link rel="stylesheet" href="../public/css/stylesparrainage.Css">
</head>
<body class="bg-light">
    ...
    <nav class="navbar navbar-expand-lg fixed-top">
        <div class="container"  style=" height: 60px;">
            <a class="navbar-brand logo-left" href="#">
                <img src="../public/images/zeduc logo.jpg" alt="Logo" style="max-height: 70px; max-width: 100px;" class="logo">
            </a>
            <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
                <img src="../public/images/hamburger icon.jpg" alt="Hamburger menu">
            </button>
            <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="../views/parrainage.html">PARRAINAGE</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container text-center my-5">
        <img src="../public/images/imageparrainage.jpg" alt="Rejoignez la bande de gourmands!" class="img-fluid">
    ...
    <footer class="text-dark text-center py-4">
        <div class="container d-flex justify-content-between align-items-center">
            <div class="d-flex align-items-center">
                <img src="../public/images/zeduc logo.jpg" alt="Logo" style="max-height: 50px; margin-right: 15px;">
